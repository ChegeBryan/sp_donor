...
class CreateProfileForm extends StatefulWidget {
  final int userId;
  const CreateProfileForm({Key? key, required this.userId}) : super(key: key);
...
class CreateProfileFormState extends State<CreateProfileForm> {
  ...
  final TextEditingController _hairColor = TextEditingController();
            ...
            child: ElevatedButton(
              onPressed: () {
                if (_formKey.currentState!.validate()) {
                  ...
                  final Future<Map<String, dynamic>> createProfile =
